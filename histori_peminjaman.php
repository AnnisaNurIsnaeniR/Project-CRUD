    ...
    <tbody>
        ...
        while($dt_histori=mysqli_fetch_array($qry_histori)){
            ...
            while($dt_buku=mysqli_fetch_array($qry_buku)){
                $buku_dipinjam.="<li>".$dt_buku['judul_buku']."</li>";
            }
            $buku_dipinjam.="</ol>";
            ...
            if(mysqli_num_rows($qry_cek_kembali)>0){
                ...
                $button_kembali="<a href='kembali.php?id=".$dt_histori['id_peminjaman_buku']."' class='btn btn-warning' onclick='return confirm(\"Yakin akan mengembalikan buku?\")'>Kembalikan</a>";
            }
        ?>
            <tr>
